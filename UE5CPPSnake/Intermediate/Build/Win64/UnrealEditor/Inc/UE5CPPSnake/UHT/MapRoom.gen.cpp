...
struct Z_Construct_UClass_AMapRoom_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Edges_MetaData[] = {
		{ "Category", "MapRoom" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//static mesh for edges where walls collide\n" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Game/MapRoom.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "static mesh for edges where walls collide" },
#endif
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_ehren_OneDrive_Dokument_Indra_repos_Github_UE5CPPSnakeRepo_UE5CPPSnake_Source_UE5CPPSnake_Game_MapRoom_h_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ehren_OneDrive_Dokument_Indra_repos_Github_UE5CPPSnakeRepo_UE5CPPSnake_Source_UE5CPPSnake_Game_MapRoom_h_1251097138(TEXT("/Script/UE5CPPSnake"),
	Z_CompiledInDeferFile_FID_Users_ehren_OneDrive_Dokument_Indra_repos_Github_UE5CPPSnakeRepo_UE5CPPSnake_Source_UE5CPPSnake_Game_MapRoom_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ehren_OneDrive_Dokument_Indra_repos_Github_UE5CPPSnakeRepo_UE5CPPSnake_Source_UE5CPPSnake_Game_MapRoom_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
